const UsersPage = (function() {
  ...
  function renderUsers() {
    ...
    tbody.querySelectorAll(".edit-user-btn").forEach((btn) => {
      btn.addEventListener("click", function() {
        showEditUserModal(this.dataset.id);
      });
    });
    tbody.querySelectorAll(".delete-user-btn").forEach((btn) => {
      btn.addEventListener("click", function() {
        confirmDeleteUser(this.dataset.id);
      });
    });
  ...
  function showAddUserModal() {
    const html = '<div class="form-row"><div class="form-group"><label class="form-label" for="uName">Full Name <span class="form-label__required">*</span></label><input type="text" class="form-input" id="uName" name="name" required></div><div class="form-group"><label class="form-label" for="uEmail">Email <span class="form-label__required">*</span></label><input type="email" class="form-input" id="uEmail" name="email" required></div></div><div class="form-row"><div class="form-group"><label class="form-label" for="uRole">Role</label><select class="form-select" id="uRole" name="role"><option>Admin</option><option selected>Editor</option><option>Viewer</option></select></div><div class="form-group"><label class="form-label" for="uPlan">Plan</label><select class="form-select" id="uPlan" name="plan"><option>Free</option><option selected>Pro</option><option>Enterprise</option></select></div></div>';
    ModalSystem.form("Add New User", html, "Add User", function(data) {
      ...
      if (!data.email || data.email.trim() === "") {
        ...
        if (emailInput) emailInput.classList.add("form-input--error");
      }
