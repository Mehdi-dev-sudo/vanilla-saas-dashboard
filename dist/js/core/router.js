const Router = (function() {
  ...
  var navGeneration = 0;
  var routeMeta = {
    dashboard: { title: function() {
      return __("route.dashboard");
    }, icon: "grid", parent: null },
    analytics: { title: function() {
      return __("route.analytics");
    }, icon: "bar-chart-2", parent: null },
    users: { title: function() {
      return __("route.users");
    }, icon: "users", parent: null },
    transactions: { title: function() {
      return __("route.transactions");
    }, icon: "credit-card", parent: null },
    settings: { title: function() {
      return __("route.settings");
    }, icon: "settings", parent: null },
    support: { title: function() {
      return __("route.support");
