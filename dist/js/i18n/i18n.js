const I18n = /* @__PURE__ */ (function() {
  ...
  function formatCurrency(amount, currency) {
    ...
    try {
      return new Intl.NumberFormat(getNumberFormat(), { style: "currency", currency, maximumFractionDigits: 0 }).format(amount);
    } catch (e) {
  ...
  function formatNumber(num) {
    try {
      return new Intl.NumberFormat(getNumberFormat()).format(num);
    } catch (e) {
