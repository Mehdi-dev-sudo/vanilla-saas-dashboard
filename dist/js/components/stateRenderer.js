const StateRenderer = (function() {
  ...
  function loading(type) {
    switch (type) {
      case "stats":
        return SkeletonLoader.getStatsSkeleton();
      case "chart":
        return SkeletonLoader.getChartSkeleton();
      case "table":
        return SkeletonLoader.getTableSkeleton(5);
      case "card":
        return SkeletonLoader.getCardSkeleton();
      case "text":
        return '<div class="skeleton skeleton--text skeleton--w-60"></div><div class="skeleton skeleton--text skeleton--w-40" style="margin-top:8px"></div>';
      default:
        return '<div class="page-loader" style="display:flex"><div class="spinner"></div></div>';
    }
  }
  ...
  function createDataView(config) {
    ...
    return { load, retry, destroy, getState: function() {
      return state;
    }, getData: function() {
      return data;
    } };
  ...
  return { ASYNC_STATES, loading, empty, filteredEmpty, error, createDataView };
})();
