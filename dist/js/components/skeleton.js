const SkeletonLoader = /* @__PURE__ */ (function() {
  ...
  function getTableSkeleton(rows) {
    ...
    html += '<div class="skeleton-table__header"><div class="skeleton skeleton--text skeleton--w-15"></div><div class="skeleton skeleton--text skeleton--w-20"></div><div class="skeleton skeleton--text skeleton--w-15"></div><div class="skeleton skeleton--text skeleton--w-15"></div><div class="skeleton skeleton--text skeleton--w-15"></div></div>';
    for (var i = 0; i < rows; i++) {
      html += '<div class="skeleton-table__row"><div class="skeleton skeleton--text skeleton--w-25"></div><div class="skeleton skeleton--text skeleton--w-35"></div><div class="skeleton skeleton--text skeleton--w-20"></div><div class="skeleton skeleton--text skeleton--w-15"></div><div class="skeleton skeleton--text skeleton--w-20"></div></div>';
    }
    html += "</div>";
    return html;
  }
