var DevConsole = (function() {
  ...
  function init() {
    ...
    document.getElementById("devClearCache").addEventListener("click", function() {
      ApiClient.clearCache();
      ToastSystem.success("API cache cleared");
      updateMetrics();
    });
    document.getElementById("devClearStorage").addEventListener("click", function() {
      if (confirm("Clear all localStorage?")) {
        localStorage.clear();
        ToastSystem.success("Storage cleared");
        updateMetrics();
      }
    });
    document.getElementById("devResetData").addEventListener("click", function() {
