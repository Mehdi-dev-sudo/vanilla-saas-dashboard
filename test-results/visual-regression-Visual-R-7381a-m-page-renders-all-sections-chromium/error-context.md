...
- Name: visual-regression.spec.js >> Visual Regression >> design-system page renders all sections
- Location: __tests__\e2e\visual-regression.spec.js:7:3
...
Call log:
  - waiting for locator('.ds-layout') to be visible
  ...
  - banner [ref=e4]:
    ...
    - generic [ref=e12]:
      - button "Toggle theme" [ref=e13] [cursor=pointer]:
        - img [ref=e14]
      - generic "Current time" [ref=e20]: 15:14:13
