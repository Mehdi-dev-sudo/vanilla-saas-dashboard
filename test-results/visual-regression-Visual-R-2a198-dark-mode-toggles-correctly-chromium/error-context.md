...
- Name: visual-regression.spec.js >> Visual Regression >> dark mode toggles correctly
- Location: __tests__\e2e\visual-regression.spec.js:37:3
  ...
  - banner [ref=e4]:
    ...
    - generic [ref=e12]:
      - button "Toggle theme" [ref=e13] [cursor=pointer]:
        - img [ref=e14]
      - generic "Current time" [ref=e20]: 15:14:50
      - generic "Online users" [ref=e21]: 19 online
